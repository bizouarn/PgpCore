...
namespace PgpCore.Abstractions
{
    ...
    {
        void Sign(FileInfo inputFile, FileInfo outputFile, bool armor = true, string name = null,
            IDictionary<string, string> headers = null, bool oldFormat = false);

        void Sign(Stream inputStream, Stream outputStream, bool armor = true, string name = null,
            IDictionary<string, string> headers = null, bool oldFormat = false);

        string Sign(string input, string name = null, IDictionary<string, string> headers = null,
        ...
        void SignFile(FileInfo inputFile, FileInfo outputFile, bool armor = true, string name = null,
            IDictionary<string, string> headers = null, bool oldFormat = false);

        void SignStream(Stream inputStream, Stream outputStream, bool armor = true, string name = null,
            IDictionary<string, string> headers = null, bool oldFormat = false);

        string SignArmoredString(string input, string name = null, IDictionary<string, string> headers = null,
            bool oldFormat = false);
